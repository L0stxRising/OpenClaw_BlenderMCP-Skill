...
**Date:** 2026-03-03
**Repository:** `/home/l0stsky/.openclaw_workspace/skills/blender-mcp-skill/`
...
- **Blender 3.6+** installed (typically `/opt/blender-3.6.23` or similar)
...
For a standard OpenClaw conda setup:
...
```json
{
  "servers": {
    "blender": {
      "type": "stdio",
      "command": "/home/youruser/miniconda/envs/OpenClawENV/bin/blender-mcp",
      "env": {
        "BLENDER_HOST": "localhost",
        "BLENDER_PORT": "9876"
      }
